...
if ($inciso == 1){
    ...
    <a class="btn btn-default download btn-export-cancel"  ng-click="editbox.open('export-inciso1', $event)" rel="noopener noreferrer">CSV Dataprev</a>
    ...
    ?>
    <a class="btn btn-default download form-export-clear" ng-click="editbox.open('export-inciso2', $event)" rel="noopener noreferrer">CSV Dataprev</a>
    ...
    ?>
        <a class="btn btn-default download form-export-clear" ng-click="editbox.open('export-inciso3', $event)" rel="noopener noreferrer">CSV Dataprev</a> 
        <!-- Formulario para cpf -->
        <edit-box id="export-inciso3" position="top" title="<?php i::esc_attr_e('Exportar CSV Inciso III') ?>" cancel-label="Cancelar" close-on-cancel="true">
            <form class="form-export-dataprev" action="<?=$route?>" method="POST">
