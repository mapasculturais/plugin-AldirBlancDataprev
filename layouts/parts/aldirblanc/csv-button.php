...
$label = isset($project) ? "CSV Dataprev - Inciso {$inciso}" : "CSV Dataprev";

if ($inciso == 1){
    $route = MapasCulturais\App::i()->createUrl('dataprev', 'export_inciso1');    
    ?>
    
    <a class="btn btn-default download btn-export-cancel"  ng-click="editbox.open('<?= $slug ?>-export-inciso1', $event)" rel="noopener noreferrer"><?= $label ?></a>
    ...
    ?>
    <a class="btn btn-default download form-export-clear" ng-click="editbox.open('<?= $slug ?>-export-inciso2', $event)" rel="noopener noreferrer"><?= $label ?></a>
    ...
    ?>
        <a class="btn btn-default download form-export-clear" ng-click="editbox.open('<?= $slug ?>-export-inciso3', $event)" rel="noopener noreferrer"><?= $label ?></a> 
        <!-- Formulario para cpf -->
